...
- Assign the following permissions to the role:
  ...
  - View Channel
  - Assign Roles
- Ensure the bot's role is above any roles you are going to add as a reaction role or auto role.
...
- Follow the [Getting Started Guide](./getting-started.mdx) to set up your bot and configure it for your server.
- You can view all available commands [here](../references/commands).
