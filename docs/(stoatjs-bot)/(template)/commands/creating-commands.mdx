...
<Callout>
  This section assumes your prefix is `!`. If you changed your prefix, replace `!` with your actual prefix.
</Callout>
...
<AutoTypeTable path="content/docs/(stoatjs-bot)/(template)/interfaces.ts" name="Command" />
